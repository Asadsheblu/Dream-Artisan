...
const Checkout = () => {
    ...
    return (
       ...
       <div className="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
          <h5 className="my-0 mr-md-auto font-weight-normal">Checkout Page</h5>
          ...
          <div className="row">
            ...
            <div className="col-md-12 order-md-1">
              ...
              <form className="needs-validation" >
                ...
                <hr className="mb-4" />
                <button onClick={handelCheckout} className="btn btn-primary btn-lg btn-block" type="button">Continue to checkout</button>
              </form>
            </div>
          </div>
